...
const requiredFiles = [
  ...
  "scripts/mssql-sync/inventory-db-ide.sh",
  "scripts/mssql-sync/compare-rowcounts-db-ide.sh",
  "scripts/mssql-sync/sql/db-ide-inventory.sql",
...
test("mssql-sync common carrega credenciais ald-sys8", () => {
  ...
  assert.match(content, /DB_PASSWORD_ALD/);
});

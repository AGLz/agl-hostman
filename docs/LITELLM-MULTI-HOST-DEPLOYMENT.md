...
**Ollama primário (2026-06-12) — VM310 AGLSRV3:** `http://100.67.253.52:11434` (Tailscale `aglsrv3-ollama`); LAN `192.168.15.210`. LiteLLM canónico (`config.yaml`): `agl-primary` → `qwen3:8b`; `ollama-gemma4-qat` / `ollama-gemma3-4b`; ver [`docs/AGL-OLLAMA-VM310.md`](AGL-OLLAMA-VM310.md).

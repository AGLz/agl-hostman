...
import HostMissionControl from "./pages/HostMissionControl";
            ...
            <MissionControlLayout>
                ...
                >
                    <Routes>
                        ...
                        />
                        <Route
                            path="/mission-control/minions"
                            element={<MissionControlMinions />}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path="/mission-control/hosts/:code"
                            element={<HostMissionControl />}
                        />
                        <Route
                            path="/mission-control/studio"
                            element={<MissionControlStudio />}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path="/mission-control/team"
                            element={<AITeamView />}
                        />
                        <Route
                            path="/mission-control/teams"
                            element={<TeamsView />}
                        />
                        <Route
                            path="/mission-control/openclaw"
                            element={<TeamsView />}
                        />
                        <Route
                            path="/mission-control/memory"
                            element={<MemoryView />}
                        />
                        <Route
                            path="/mission-control/calendar"
                            element={<CalendarView />}
                        />
                        <Route
                            path="/mission-control/contacts"
                            element={<ContactsView />}
                        />
                        <Route
                            path="/mission-control/settings"
                            element={<MissionControlSettings />}
                        />

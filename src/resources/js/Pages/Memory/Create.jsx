...
export default function Create({ auth, defaultDate }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={
                <div>
                    <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Novo registo diário</h1>
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Cola o resumo da sessão; usa etiquetas para projetos e filtros futuros.
                    </p>
                </div>
            }
        >
            <Head title="Novo registo - Memória" />
                    ...
                    <form onSubmit={submit} className="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div>
                            <label htmlFor="topics" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Tópicos (separados por vírgula ou nova linha)
                            </label>
                            <input
                                id="topics"
                                type="text"
                                ...
                                className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                                placeholder="ex.: litellm, deploy, review"
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                                placeholder="ex.: agl-hostman, infra"
                            />
                            {errors.project_tags && (

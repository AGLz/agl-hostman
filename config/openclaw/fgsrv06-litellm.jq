...
# substituir apenas baseUrl que apontam ao gateway central CT186 — preserva o resto do objeto (ex.: moonshot.models).
#
...
walk(
  if type == "object" and (.baseUrl? | type == "string") and (.baseUrl | contains("100.125.249.8:4000"))

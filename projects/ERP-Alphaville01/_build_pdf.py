#!/usr/bin/env python3
"""Converte os documentos markdown da proposta ERP em PDF (estilo limpo)."""
import sys
...
docs = [
    ("ERP-ALPHAVILLE-MARKET-RESEARCH.md", "ERP-ALPHAVILLE-MARKET-RESEARCH.pdf"),
    ("PROPOSTA-ERP-ALPHAVILLE.md", "PROPOSTA-ERP-ALPHAVILLE.pdf"),
]

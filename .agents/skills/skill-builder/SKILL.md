---
name: "Skill Builder"
description: "Create production-ready Codex Skills with proper YAML frontmatter (name, description fields required, maximum 1024 character description), progressive disclosure architecture for complexity management, complete file/folder structure organization, and compliance with Codex Skills specification enabling autonomous discovery across Codex.ai, Codex, SDK, and API surfaces. Use this skill when creating new skills with `mkdir -p ~/.Codex/skills/my-skill` for top-level skill directories (MUST be at top level, NOT in subdirectories), writing SKILL.md files with required YAML frontmatter including name and description fields, implementing progressive disclosure with collapsible sections for gradual complexity revelation, organizing skill content with clear structure (What This Skill Does, Prerequisites, Quick Start, Complete Guide, Advanced Topics, Troubleshooting), ensuring descriptions are discoverable by including specific tools, file types, situations, and use cases within 1024 character limit, understanding when Codex uses skills (descriptions should clearly state triggering conditions like 'Use when building REST APIs' or 'Use when working with .tsx files'), creating Quick Start sections with minimal examples for immediate productivity, implementing progressive disclosure with `<details><summary>` tags hiding advanced content until needed, organizing supporting files in skill directory (scripts/, examples/, docs/, templates/), writing clear prerequisites listing required tools, dependencies, versions, and prior knowledge, including troubleshooting sections addressing common errors and solutions, testing skills by restarting Codex or refreshing Codex.ai to verify detection, documenting skill maintenance with version numbers, update logs, and deprecation notices, creating skill categories for organization (development, testing, deployment, documentation, analysis), implementing skill dependencies when one skill requires another, using tags for discoverability and filtering (github, testing, performance, security), writing examples that demonstrate actual usage patterns not just syntax, including code snippets with proper syntax highlighting and language annotations, or troubleshooting skill not detected issues (check top-level location, YAML syntax, restart Codex), missing descriptions causing poor discoverability, or incorrect frontmatter format breaking parsing. Essential for extending Codex with custom workflows and domain-specific knowledge, building reusable skill libraries for team standardization, documenting best practices as executable skills, creating organization-specific development methodologies, sharing knowledge across Codex surfaces (desktop, web, API), and empowering Codex to autonomously discover and apply specialized skills for improved productivity and consistency."
---

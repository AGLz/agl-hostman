...
write_kv CEREBRAS_API_KEY "${CEREBRAS_API_KEY:-}"
write_kv GROQ_API_KEY "${GROQ_API_KEY:-}"
write_kv GROQ_API_KEY2 "${GROQ_API_KEY2:-}"

# Telegram (OpenClaw: channels.telegram com token=env).

#!/usr/bin/env bash
# Todos os agents Hermes → auth2api Plus/Pro (CT186). Auxiliares = glm.
...
echo "  Jarvis(Fable5)=$JARVIS_MODEL Elon=$ELON_MODEL Werner=$WERNER_MODEL"
echo "  Satya/Curator/Orion/Verifier/Composio=sonnet Argus=$ARGUS_MODEL"
echo "  Fallback=$FALLBACK_MODEL Aux=$AUXILIARY_MODEL LiteLLM=$LITELLM_TS"
